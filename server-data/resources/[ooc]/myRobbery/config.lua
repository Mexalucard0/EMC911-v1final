...
Translation = {
    ['de'] = {
        ['infobar_enter'] = 'Drücke ~o~E~s~, um in die Wohnung ~o~einzubrechen',
        ['infobar_leave'] = 'Drücke ~o~E~s~, um den Einbruch zu beenden',
        ['infobar_code'] = 'Drücke ~r~G~s~, um den Code einzugeben',
        ['infobar_seller'] = 'Drücke ~o~E~s~, um mit dem Händler zu sprechen',
        ['no_lockpick'] = '~r~Du hast keinen Dietrich',
        ['collect_items'] = 'Drücke ~g~E~s~, um einzustecken.',
        ...
        ['too_late_rob_aborted'] = '~r~Es ist zu spät und die Bewohner wachen auf! Mach dich aus dem Staub!',
        ['screen_deactivatealarm'] = '~b~Deaktiviere den Alarm zuerst.',
        ['screen_alarmtime'] = '~r~Alarm: ~w~',
        ['screen_alarmtime2'] = 's verbleibend',
        ['screen_police'] = '~r~Die Polizei wurde informiert!',
        ['screen_alarmdisabled'] = '~g~Alarm deaktiv',
        ['insert_deactivation'] = 'Gebe den Deaktivierungs-Code ein',
        ['alarm_deactivated'] = 'Der ~r~Hausalarm ~s~wurde ~g~deaktiviert~s~!',
        ['wrong_code'] = '~r~Falscher Code eingegeben!',
        ['already_robbed'] = '~r~Du musst ~w~',
        ['already_robbed2'] = ' Minuten ~r~warten, bevor der Einbruch erneut gestartet werden kann!',
        ['3D_alarmtext'] = '~r~Alarm ~s~Code: ~y~',
        ['house_alarm'] = 'Stiller Alarm',
        ['house_alarm_msg'] = 'Ein ~r~stiller Alarm ~s~wurde ausgelöst in ~y~',
        ['house_robbery'] = 'Einbruch',
        ['end_robbery_seller'] = '~g~Robbery finished!',
        ['not_enough_cops'] = '~r~Nicht genügend Cops online',
    },
    ['en'] = {
