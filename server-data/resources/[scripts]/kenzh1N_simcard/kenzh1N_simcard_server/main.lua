		...
		MySQL.Async.fetchAll(
			...
			function(result)
				...
				MySQL.Async.execute(
					...
					function (rowsChanged)
					TriggerClientEvent('esx:showNotification', source, "你成功购买了一个新SIM卡")
					end
				)
		end)
end
...
AddEventHandler('kenzh1N:sim_give', function (store, index)
  ...
  TriggerClientEvent('esx:showNotification', _source, "你已将该SIM卡给与其他玩家，被给与的号码为：~o~" .. simZ)
  TriggerClientEvent('esx:showNotification', id, "其他玩家已经获得了你的SIM卡，号码为：~o~" .. simZ)
