...
RegisterNetEvent('emc:loadCharacters')
AddEventHandler('emc:loadCharacters', function()
	isSpawn = true
    ESX.PlayerData = ESX.GetPlayerData()
	TriggerEvent('emc:loadCharacters_pause')
end)

RegisterCommand("reloadui", function(thePlayer, args, rawCommand)
	isSpawn = true
    ESX.PlayerData = ESX.GetPlayerData()
	TriggerEvent('emc:loadCharacters_pause')
end)
