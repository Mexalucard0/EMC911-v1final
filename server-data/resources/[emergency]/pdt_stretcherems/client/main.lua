local labels = {
  { "MENU_AMBO_HELP", "按下 ~INPUT_CONTEXT~ 打开/关闭后门 ~n~按下 ~INPUT_CELLPHONE_CAMERA_FOCUS_LOCK~ 放入/弹出担架 ~n~按下 ~INPUT_FRONTEND_SELECT~ 打开侧门 ~n~按下 ~INPUT_SKIP_CUTSCENE~ 改变车灯" },
  { "MENU_AMBO_HELP2", "按下 ~INPUT_CONTEXT~ 打开/关闭后门 ~n~按下 ~INPUT_DETONATE~ 取出担架 ~n~按下 ~INPUT_CELLPHONE_CAMERA_FOCUS_LOCK~ 放入/弹出担架 ~n~按下 ~INPUT_FRONTEND_SELECT~ 打开侧门 ~n~按下 ~INPUT_SKIP_CUTSCENE~ 改变车灯" },
  { "MENU_AMBO_HELP3", "按下 ~INPUT_CONTEXT~ 打开/关闭后门 ~n~按下 ~INPUT_DETONATE~ 放入担架 ~n~按下 ~INPUT_CELLPHONE_CAMERA_FOCUS_LOCKL~ 放入/弹出担架 ~n~按下 ~INPUT_SKIP_CUTSCENE~ 改变车灯" }
}
...
Citizen.CreateThread(function()
  ...
  WarMenu.SetTitleBackgroundSprite('hopital', '', 'banner')
