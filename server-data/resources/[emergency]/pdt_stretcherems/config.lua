...
Config.Language = {
	name_hospital = '担架',
	open_menu = '按下 ~b~E',
	do_action = '按下 ~INPUT_CONTEXT~ 与担架交互',
	take_bed = "按下 ~INPUT_CONTEXT~ 抬起担架",
	release_bed = "按下 ~INPUT_SPECIAL_ABILITY_SECONDARY~ 放下担架",
	in_vehicle_bed = "按下 ~INPUT_CONTEXT~ 将担架放在车上",
	out_vehicle_bed = "按下 ~INPUT_CONTEXT~ 将担架从车上取下",
	go_out_bed = "从担架上下来",
	delete_bed = "移除担架",
	fold_bed = "折叠担架",
	toggle_iv = "静脉注射",
